...
const req03 = require("./req03");
const req04 = require("./req04");
const req05 = require("./req05");
...
router.use("/api/req03", req03);
router.use("/api/req04", req04);
router.use("/api/req05", req05);
